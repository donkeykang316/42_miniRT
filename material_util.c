...
/*   Updated: 2024/08/25 14:56:24 by kaan             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_vec	refract(t_vec uv, t_vec n, double etai_over_etat)
{
	...
	r_out_perp = mul_vec_double(add_vec_vec(uv,
				mul_vec_double(n, cos_theta)), etai_over_etat);
	r_out_parallel = mul_vec_double(n,
