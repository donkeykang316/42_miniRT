...
/*   Updated: 2024/08/10 03:18:52 by kaan             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    ambient_init(t_amblight *ambient)
{
    ambient->intensity = 0.1;
    ambient->color = vec_init(0.0 + ambient->intensity, 0.0 + ambient->intensity, 0.0 + ambient->intensity);
}
