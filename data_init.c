...
void    world_init(t_object_list **world)
{
    ...
    world[3]->sphere = NULL;
    world[3]->type = QUAD;
    world[3]->quad = malloc(sizeof(t_quad));
    world[3]->quad->q = vec_init(-2, 3, 1);
    world[3]->quad->u = vec_init(4, 0, 0);
    world[3]->quad->v = vec_init(0, 0, 4);
    world[3]->quad->material = malloc(sizeof(t_material));
    world[3]->quad->material->albedo = vec_init(1.0, 0.5, 0.0);
    world[3]->quad->material->type = LAMBERTIAN;
    world[3]->quad->material->fuzz = 0.0;
