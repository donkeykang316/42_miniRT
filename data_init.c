...
void    world_init(t_object_list *world)
{
    ...
    world->sphere[0]->material = &material_ground;
    ...
    world->sphere[1]->material = &material_center;
    ...
    world->sphere[2]->material = &material_left;
    ...
    world->sphere[3]->material = &material_right;
